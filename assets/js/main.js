...
var p_tag_6 = document.getElementById('p_tag_6');
...
var btn__6 = document.getElementById('btn__6');
...
function checkshowmore_5() {
  showmore(p_tag_6, 'A note worthy portfolio visualizing 3D interfaces');
  offdisplay(btn_6, btn__6);
}

function checkshowless_5() {
  showmore(p_tag_6, 'A note worthy portfolio visualizing 3D interfaces');
  offdisplay(btn_6, btn__6);
}
...
btn_6.addEventListener('click', checkshowmore_5);
...
btn__6.addEventListener('click', checkshowless_5);
